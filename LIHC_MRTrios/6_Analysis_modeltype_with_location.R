# ============================================================
# Annotate LIHC trio results with CpG genomic location
...
raw_dir    <- "/Users/lianzuo/LZ/ResearchProject/Fulab/GDCdata/TCGA-LIHC/raw_data"
out_dir    <- "/Users/lianzuo/LZ/ResearchProject/Fulab/MRTrios_LIHC/Output_LIHC"
model_file <- "/Users/lianzuo/LZ/ResearchProject/Fulab/MRTrios_LIHC/Output_LIHC/LIHC_trio_Model_results_ALL_with_BH_fdr_qval_byLZ.txt"
...
setwd("/Users/lianzuo/LZ/ResearchProject/Fulab/GDCdata/TCGA-LIHC/raw_data")
...
## ---- Methylation -----------------------------------------------------------
LIHC.meth <- readRDS("split.names.LIHC.meth.logit.rds")                                  # [421414, 444]
...
loc_file <- file.path(out_dir, "LIHC_final_protein_coding_location_byLZ.txt")
...
# ============================================================
Model_LIHC <- fread(model_file, sep = "\t", data.table = FALSE)

Model_LIHC$Inferred.Model3 <- Model_LIHC$Inferred.Model.BH_fdr

n_model_rows <- nrow(Model_LIHC)

merge_Model_LIHC_df <- left_join(
  Model_LIHC, loc,
  by = c("trio_row" = "trios_row", "cna.row", "gene.row", "meth.row")
)

if (nrow(merge_Model_LIHC_df) != n_model_rows) {
  warning(sprintf(
...
# ============================================================
# final_file <- file.path(out_dir, "LZ_trio_results_Model_LIHC_ALL_with_BH_fdr_qval_with_location.txt")
# fwrite(Model_LIHC_df_2, final_file, sep = "\t", quote = FALSE, row.names = FALSE, col.names = TRUE)

final_file <- file.path(out_dir, "LZ_trio_results_Model_LIHC_ALL_with_BH_fdr_qval_with_location.rds")
saveRDS(Model_LIHC_df_2, final_file, compress = "xz")

cat(sprintf("Done. Final file: %s (%d rows)\n", final_file, nrow(Model_LIHC_df_2)))

## Final file: /Users/lianzuo/LZ/ResearchProject/Fulab/MRTrios_LIHC/Output_LIHC/LZ_trio_results_Model_LIHC_ALL_with_BH_fdr_qval_with_location.txt (675071 rows)
