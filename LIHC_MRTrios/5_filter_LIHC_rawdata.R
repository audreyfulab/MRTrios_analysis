...
setwd("/Users/lianzuo/LZ/ResearchProject/Fulab/GDCdata/TCGA-LIHC/")
...
saveRDS(preprocessed,"LIHC_data_filter_list.rds")

LIHC_filter <- readRDS("LIHC_data_filter_list.rds") #load it
